MonsterPalettes:
	...
	db PAL_GREENMON  ; PINEPREVO (UNF)
	db PAL_GREENMON  ; PINEGUIN (CAP)
	...
	db PAL_YELLOWMON ; MANDRELEC (CAP)
	...
	db PAL_PURPLEMON ; PREVOSPARO (UNF)
	db PAL_PURPLEMON ; SPAROPHIM (CAP)
