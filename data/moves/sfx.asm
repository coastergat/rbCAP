MoveSoundTable:
	...
	db SFX_BATTLE_35,          $42, $01 ; SUGAR_RUSH, DREAM_EATER CLONE (CHANGE THIS)
	db SFX_BATTLE_14,          $01, $e0 ; MARBLE_FIST, ROCK_THROW CLONE
	db SFX_NOT_VERY_EFFECTIVE, $20, $c0 ; CAMOUFLAGE, FLY CLONE
	db SFX_BATTLE_28,          $40, $80 ; ICICLE, ICE_BEAM CLONE
