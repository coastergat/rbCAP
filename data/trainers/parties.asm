...
BrunoData:
	db $FF, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, GARGOYLE, 56, POLIWRATH, 58, MACHAMP, 0
...
LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, PROBOSICLE, 54, PINEGUIN, 56, JYNX, 56, LAPRAS, 0
...
AgathaData:
	db $FF, 56, GENGAR, 56, SPAROPHIM, 55, HAUNTER, 58, ARBOK, 58, PHANTOM, 60, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, GARGOYLE, 56, DRAGONAIR, 58, CORUPCAKE, 60, AERODACTYL, 62, DRAGONITE, 0
